...
const JobDetails = () => {
  ...
  return (
    <div className="w-11/12 bg-slate-100 mx-auto font-serif p-5 md:p-10">
      ...
      <img className="w-20 h-48 md:w-72 absolute inset-y-0 left-0 " src="../../../public/All Images/Vector-1.png" alt="" />
      <img className="w-20 h-48 md:w-72 absolute inset-y-0 right-0 " src="../../../public/All Images/Vector.png" alt="" />
      </div>
